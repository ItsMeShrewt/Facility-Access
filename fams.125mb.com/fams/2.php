    ...
    <div class="col-lg-5">
      <div class="card">
        <div class="card-body">
          <?php
                $id = $_GET['id'];
                $sql1= mysqli_query($mycon, "SELECT * from lab2 where id='$id'") or die (mysqli_error());
                WHILE($lab2=mysqli_fetch_array($sql1)){
                 
                $id= $lab2['id'];
                $monday = $lab2['monday'];
                $tuesday = $lab2['tuesday'];
				$wednesday = $lab2['wednesday'];
				$thursday = $lab2['thursday'];
				$friday = $lab2['friday'];
				$saturday = $lab2['saturday'];
...
Fill out the fields for <b>SUBJECT</b>, <b>INSTRUCTOR (Last Name)</b>, <b>TIME (e.g., 7-10am)</b>, and <b>SECTION</b>. If vacant, just put <b>"VACANT"</b> and its <b>TIME</b>, then click <b>ADD</b> to save.</p>
          ...
          <form method="post" action="update2.php" class="g-3">
            <!-- Row 1 -->
