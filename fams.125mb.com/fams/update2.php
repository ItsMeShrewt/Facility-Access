<?php
    ...
    $query_current = "SELECT * FROM lab2 WHERE id = '$id'";
    ...
    if (
        ...
        foreach ($days as $day) {
            $query_day = "SELECT * FROM lab2 WHERE $day = '{$day}' AND id != '$id'";
        ...
        if ($duplicate) {
            ...
            $sql = mysqli_query($mycon, "UPDATE lab2 SET monday='$monday', tuesday='$tuesday', wednesday='$wednesday', thursday='$thursday', 
