<?php
    ...
    $query_current = "SELECT * FROM room12 WHERE id = '$id'";
    ...
    if (
        ...
        foreach ($days as $day) {
            $query_day = "SELECT * FROM room12 WHERE $day = '{$day}' AND id != '$id'";
        ...
        if ($duplicate) {
            ...
            $sql = mysqli_query($mycon, "UPDATE room12 SET monday='$monday', tuesday='$tuesday', wednesday='$wednesday', thursday='$thursday', 
