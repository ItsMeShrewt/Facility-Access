<?php
    ...
    if ($lname == "" || $fname == "" || $mname == "" || $sid == "" || $course == "" || $section == "" || $subject == "" || $instructor == ""
        ...
        $checkQuery = "SELECT * FROM studentlab WHERE lab = '$lab' AND date = '$date' AND (
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            $insertQuery = "INSERT INTO studentlab(lname, fname, mname, sid, course, section, subject, instructor, date, start, end, reason, lab) 
                            VALUES('$lname', '$fname', '$mname', '$sid', '$course', '$section', '$subject', '$instructor', '$date', '$start', '$end', '$reason', '$lab')";
