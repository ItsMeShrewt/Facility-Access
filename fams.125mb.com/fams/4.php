    ...
    <div class="col-lg-5">
      <div class="card">
        <div class="card-body">
          <?php
                $id = $_GET['id'];
                $sql1= mysqli_query($mycon, "SELECT * from lab4 where id='$id'") or die (mysqli_error());
                WHILE($lab4=mysqli_fetch_array($sql1)){
                 
                $id= $lab4['id'];
                $monday = $lab4['monday'];
                $tuesday = $lab4['tuesday'];
				$wednesday = $lab4['wednesday'];
				$thursday = $lab4['thursday'];
				$friday = $lab4['friday'];
				$saturday = $lab4['saturday'];
...
Fill out the fields for <b>SUBJECT</b>, <b>INSTRUCTOR (Last Name)</b>, <b>TIME (e.g., 7-10am)</b>, and <b>SECTION</b>. If vacant, just put <b>"VACANT"</b> and its <b>TIME</b>, then click <b>ADD</b> to save.</p>
          ...
          <form method="post" action="update4.php" class="g-3">
            <!-- Row 1 -->
