...
<html lang="en">
  <head>
    ...
    <title>Edit / ComLab 2 - FAMS</title>
      ...
      <div class="pagetitle">
        ...
        <nav>
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">ComLab 2</li>
          </ol>
        </nav>
      </div>
      <!-- End Page Title -->
<section class="section">
  <div class="row">
    <div class="col-lg-5">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Schedule for ComLab 2</h5>
          <hr>
          <p><b>Description:</b> 
Fill out the inputs for <b>SUBJECT</b>, <b>INSTRUCTOR (Last Name)</b>, <b>TIME (e.g., 7-10am)</b>, and <b>SECTION</b>. If vacant, just put <b>"VACANT"</b> and its <b>TIME</b>, then click <b>ADD</b> to save.</p>
          ...
          <form method="post" action="lab2.php" class="g-3">
            <!-- Row 1 -->
            ...
            ?>
              <tr>
                    ...
                    <td class="table-dark" style="font-size: 22px;">
                        <a href=delete2.php?id=<?php echo $id; ?>><i class="bi bi-trash-fill text-danger"></i>&nbsp;</a> |&nbsp;
                        <a href="2.php?id=<?php echo $id; ?>"><i class="bi bi-pen-fill"></i></a>
                    </td>
                </tr>
             <?php } ?>
            </tbody>
