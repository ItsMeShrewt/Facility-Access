    ...
    <div class="col-lg-5">
      <div class="card">
        <div class="card-body">
          <?php
                $id = $_GET['id'];
                $sql1= mysqli_query($mycon, "SELECT * from lab3 where id='$id'") or die (mysqli_error());
                WHILE($lab3=mysqli_fetch_array($sql1)){
                 
                $id= $lab3['id'];
                $monday = $lab3['monday'];
                $tuesday = $lab3['tuesday'];
				$wednesday = $lab3['wednesday'];
				$thursday = $lab3['thursday'];
				$friday = $lab3['friday'];
				$saturday = $lab3['saturday'];
...
Fill out the fields for <b>SUBJECT</b>, <b>INSTRUCTOR (Last Name)</b>, <b>TIME (e.g., 7-10am)</b>, and <b>SECTION</b>. If vacant, just put <b>"VACANT"</b> and its <b>TIME</b>, then click <b>ADD</b> to save.</p>
          ...
          <form method="post" action="update3.php" class="g-3">
            <!-- Row 1 -->
