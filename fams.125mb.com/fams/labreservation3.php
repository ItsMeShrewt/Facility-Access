        ...
        <div class="row">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <form method="post" action="labreservation.php" class="row g-3">
                  ...
                  <div class="col-8">
                    <div class="form-floating">
                      <textarea class="form-control" placeholder="Reason" id="floatingTextarea" style="height: 100px;" name="reason" readonly></textarea>
          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <?php
                $id = $_GET['id'];
                $sql1= mysqli_query($mycon, "SELECT * from inslab where id='$id'") or die (mysqli_error());
                WHILE($inslab=mysqli_fetch_array($sql1)){
                 
                $id= $inslab['id'];
				$instructor= $inslab['instructor'];
				$course= $inslab['course'];
				$section= $inslab['section'];
				$subject= $inslab['subject'];
				$date= $inslab['date'];
				$start= $inslab['start'];
                $end= $inslab['end'];
                $reason= $inslab['reason'];
                $lab= $inslab['lab'];
                }                                       
             ...
             ?>
                ...
                <!-- Custom Styled Validation -->
                <form method="post" action="updateinslab.php" class="row g-3">
                  <div class="col-md-1">
                    <div class="form-floating">
