      ...
      <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
          ...
          >
            ...
            <li>
              <a href="labreservation.php" class="active">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <?php
                $id = $_GET['id'];
                $sql1= mysqli_query($mycon, "SELECT * from studentlab where id='$id'") or die (mysqli_error());
                WHILE($studentlab=mysqli_fetch_array($sql1)){
                 
                $id= $studentlab['id'];
                $lname = $studentlab['lname'];
                $fname = $studentlab['fname'];
				$mname = $studentlab['mname'];
				$sid = $studentlab['sid'];
				$course = $studentlab['course'];
				$section = $studentlab['section'];
				$subject = $studentlab['subject'];
				$instructor = $studentlab['instructor'];
				$date = $studentlab['date'];
				$start = $studentlab['start'];
                $end = $studentlab['end'];
                $reason = $studentlab['reason'];
                $lab = $studentlab['lab'];
             ...
             ?>
                ...
                <form method="post" action="updatestudentlab.php" class="row g-3">
                  <div class="col-md-1">
                    <div class="form-floating">
                      <input type="text" class="form-control" id="floatingLast" placeholder="Last Name" value="<?php echo $id; ?>" name="id" readonly>
                      <label for="floatingName">ID</label>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-floating">
                      <input type="text" class="form-control" id="floatingLast" placeholder="Last Name" value="<?php echo $lname; ?>" name="lname">
                      <label for="floatingName">Last Name</label>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-floating">
                      <input type="text" class="form-control" id="floatingFirst" placeholder="First Name" value="<?php echo $fname; ?>" name="fname">
                      <label for="floatingEmail">First Name</label>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-floating">
                      <input type="text" class="form-control" id="floatingMiddle" placeholder="Middle Name" value="<?php echo $mname; ?>" name="mname">
                      <label for="floatingEmail">Middle Name</label>
                    </div>
                  </div>
                  <div class="col-md-2">
                    <div class="form-floating">
                      <input type="text" class="form-control" id="floatingID" placeholder="School ID" value="<?php echo $sid; ?>"  name="sid">
                  ...
                  <div class="col-md-2">
                    <div class="form-floating">
                      <input type="text" class="form-control" id="floatingInstructor" placeholder="Instructor" value="<?php echo $instructor; ?>" name="instructor">
                  ...
                  <div class="col-8">
                    <div class="form-floating">
                      <textarea class="form-control" placeholder="Reason" id="floatingTextarea" style="height: 100px;" value="<?php echo $reason; ?>" name="reason" readonly></textarea>
                      <label for="floatingTextarea">Reason For Reservation<span> (Optional)</span></label>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-floating mb-3">
                      <select class="form-select" id="floatingSelect" aria-label="" value="<?php echo $lab; ?>" name="lab">
                        <option value="Laboratory 1">ComLab 1</option>
                        <option value="Laboratory 2">ComLab 2</option>
                        <option value="Laboratory 3">ComLab 3</option>
                        <option value="Laboratory 4">ComLab 4</option>
                      </select>
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                ...
                <!-- Custom Styled Validation -->
                <form method="post" action="labreservation.php" class="row g-3">
                  <div class="col-md-2">
                    <div class="form-floating">
                      <input type="text" class="form-control" id="floatingLast" placeholder="Last Name" name="instructor">
                  ...
                  <div class="col-md-4">
                    <div class="form-floating mb-3">
                      <select class="form-select" id="floatingSelect" aria-label="" name="lab">
                        <option value="Laboratory 1">ComLab 1</option>
                        <option value="Laboratory 2">ComLab 2</option>
                        <option value="Laboratory 3">ComLab 3</option>
                        <option value="Laboratory 4">ComLab 4</option>
