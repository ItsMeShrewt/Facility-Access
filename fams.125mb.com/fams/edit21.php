      ...
      <div class="pagetitle">
        ...
        <nav>
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Room 21</li>
          </ol>
        </nav>
      </div>
      <!-- End Page Title -->
<section class="section">
  <div class="row">
    <div class="col-lg-5">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Schedule for Room 21</h5>
          <hr>
          <p><b>Description:</b> 
Fill out the inputs for <b>SUBJECT</b>, <b>INSTRUCTOR (Last Name)</b>, <b>TIME (e.g., 7-10am)</b>, and <b>SECTION</b>. If vacant, just put <b>"VACANT"</b> and its <b>TIME</b>, then click <b>ADD</b> to save.</p>

          <!-- Custom Styled Validation -->
          <form method="post" action="room21.php" class="g-3">
            <!-- Row 1 -->
          ...
          <table class="table">
            ...
            ?>
              <tr>
                    ...
                    <td class="table-lgiht" style="text-transform: uppercase; font-weight: 600;">
                    ...
                    <td class="table-dark" style="font-size: 22px;">
                        <a href=delete21.php?id=<?php echo $id; ?>><i class="bi bi-trash-fill text-danger"></i>&nbsp;</a> |&nbsp;
                        <a href="21.php?id=<?php echo $id; ?>"><i class="bi bi-pen-fill"></i></a>
                    </td>
                </tr>
              <?php } ?>
            </tbody>
