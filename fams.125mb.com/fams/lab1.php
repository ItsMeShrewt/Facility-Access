<?php
    ...
    if ($monday == "" || $tuesday == "" || $wednesday == "" || $thursday == "" || $friday == "" || $saturday == "") {
        ...
        if (mysqli_num_rows($result_monday) > 0) {
            ...
            // Insert new data
            mysqli_query($mycon, "INSERT INTO lab1(monday, tuesday, wednesday, thursday, friday, saturday) 
