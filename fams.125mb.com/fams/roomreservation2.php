          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                             <?php
                $id = $_GET['id'];
                $sql1= mysqli_query($mycon, "SELECT * from studentroom where id='$id'") or die (mysqli_error());
                WHILE($studentroom=mysqli_fetch_array($sql1)){
                 
                $id= $studentroom['id'];
                $lname = $studentroom['lname'];
                $fname = $studentroom['fname'];
				$mname = $studentroom['mname'];
				$sid = $studentroom['sid'];
				$course = $studentroom['course'];
				$section = $studentroom['section'];
				$subject = $studentroom['subject'];
				$instructor = $studentroom['instructor'];
				$date = $studentroom['date'];
				$start = $studentroom['start'];
                $end = $studentroom['end'];
                $reason = $studentroom['reason'];
                $room = $studentroom['room'];
             ...
             ?>
                ...
                <form method="post" action="updatestudentroom.php" class="row g-3">
                  <div class="col-md-1">
                  ...
                  <div class="col-8">
                    <div class="form-floating">
                      <textarea class="form-control" placeholder="Address" id="floatingTextarea" style="height: 100px;" value="<?php echo $reason; ?>"  name="reason" readonly></textarea>
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                ...
                <!-- Custom Styled Validation -->
                <form method="post" action="insroom.php" class="row g-3">
                  <div class="col-md-2">
                    <div class="form-floating">
