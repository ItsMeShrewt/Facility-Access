      ...
      <div class="pagetitle">
        ...
        <nav>
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Room 12</li>
          </ol>
        </nav>
      </div>
      <!-- End Page Title -->
    ...
    <div class="col-lg-5">
      <div class="card">
        <div class="card-body">
          <?php
                $id = $_GET['id'];
                $sql1= mysqli_query($mycon, "SELECT * from room12 where id='$id'") or die (mysqli_error());
                WHILE($room12=mysqli_fetch_array($sql1)){
                 
                $id= $room12['id'];
                $monday = $room12['monday'];
                $tuesday = $room12['tuesday'];
				$wednesday = $room12['wednesday'];
				$thursday = $room12['thursday'];
				$friday = $room12['friday'];
				$saturday = $room12['saturday'];

                }                                       

             ?>
          <h5 class="card-title">Schedule for Room 12</h5>
          <hr>
          <p><b>Description:</b> 
Fill out the fields for <b>SUBJECT</b>, <b>INSTRUCTOR (Last Name)</b>, <b>TIME (e.g., 7-10am)</b>, and <b>SECTION</b>. If vacant, just put <b>"VACANT"</b> and its <b>TIME</b>, then click <b>ADD</b> to save.</p>
          ...
          <form method="post" action="update12.php" class="g-3">
            <!-- Row 1 -->
