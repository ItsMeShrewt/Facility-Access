<?php
    ...
    $id = $_POST['id']; // Assuming 'id' is the primary key of the record
    ...
    if ($instructor == "" || $course == "" || $section == "" || $subject == "" || $date == "" || $start == "" || $end == "" || $lab == "") {
        ...
        $checkQuery = "SELECT * FROM inslab WHERE lab = '$lab' AND date = '$date' AND id != '$id' AND (
