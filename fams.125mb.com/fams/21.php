    ...
    <div class="col-lg-5">
      <div class="card">
        <div class="card-body">
          <?php
                $id = $_GET['id'];
                $sql1= mysqli_query($mycon, "SELECT * from room21 where id='$id'") or die (mysqli_error());
                WHILE($room21=mysqli_fetch_array($sql1)){
                 
                $id= $room21['id'];
                $monday = $room21['monday'];
                $tuesday = $room21['tuesday'];
				$wednesday = $room21['wednesday'];
				$thursday = $room21['thursday'];
				$friday = $room21['friday'];
				$saturday = $room21['saturday'];
...
Fill out the fields for <b>SUBJECT</b>, <b>INSTRUCTOR (Last Name)</b>, <b>TIME (e.g., 7-10am)</b>, and <b>SECTION</b>. If vacant, just put <b>"VACANT"</b> and its <b>TIME</b>, then click <b>ADD</b> to save.</p>
          ...
          <form method="post" action="update21.php" class="g-3">
            <!-- Row 1 -->
